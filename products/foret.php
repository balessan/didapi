...
<div class="row-fluid">
	<div class="span4 products-photo" style="padding-top: 15px;">
		<img src="<?php echo $include_path; ?>includes/img/pot/foret.JPG" alt="Nos pots de miel de foret" class="img-circle">
	</div>
	...
	<div class="span8">
		...
		<div class="row-fluid">
			...
			<p>
				<p>
					<b>Aspect</b> : Sa cristallisation est lente, il est généralement liquide assez longtemps et sa couleur fluctue entre le brun chaud et le brun foncé.
				</p>
				<p>
					<b>Odeur</b> : Son odeur est marquée par son lieu de production. 
				Il exprime des notes boisées de chêne et de liège, et rappelle par certains aspect l’odeur des feuilles sèches.
				</p>
				<p>
					<b>Goût</b> : Long en bouche, on perçoit une pointe d’amertume, accompagnée de notes boisées fermes rappelant les fût de chêne. 
				Il peut donner un caractère intéressant à vos préparations culinaires, ou se déguste simplement sur un toast grillé pour en apprécier tous les arômes !
				</p>
			</p>
			<p>
				Quantite:
