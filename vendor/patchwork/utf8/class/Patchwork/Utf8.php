...
class Utf8
{
    ...
    $commonCaseFold = array(
        array('ÃÂÃÂµ','ÃÂÃÂ¿',"\xCD\x85",'ÃÂÃÂ',"\xCF\x90","\xCF\x91","\xCF\x95","\xCF\x96","\xCF\xB0","\xCF\xB1","\xCF\xB5","\xE1\xBA\x9B","\xE1\xBE\xBE"),
        array('ÃÂÃÂ¼','s','ÃÂÃÂ¹',       'ÃÂÃÂ','ÃÂÃÂ²',       'ÃÂÃÂ¸',       'ÃÂÃÂ',       'ÃÂÃÂ',       'ÃÂÃÂº',       'ÃÂÃÂ',       'ÃÂÃÂµ',       "\xE1\xB9\xA1",'ÃÂÃÂ¹'           )
    ),
    $cp1252 = array('ÃÂÃÂ','ÃÂÃÂ','ÃÂÃÂ','ÃÂÃÂ','ÃÂÃÂ','ÃÂÃÂ','ÃÂÃÂ','ÃÂÃÂ','ÃÂÃÂ','ÃÂÃÂ','ÃÂÃÂ','ÃÂÃÂ','ÃÂÃÂ','ÃÂÃÂ','ÃÂÃÂ','ÃÂÃÂ','ÃÂÃÂ','ÃÂÃÂ','ÃÂÃÂ','ÃÂÃÂ','ÃÂÃÂ','ÃÂÃÂ','ÃÂÃÂ','ÃÂÃÂ','ÃÂÃÂ','ÃÂÃÂ','ÃÂÃÂ'),
    $utf8   = array('ÃÂ¢ÃÂÃÂ¬','ÃÂ¢ÃÂÃÂ','ÃÂÃÂ','ÃÂ¢ÃÂÃÂ','ÃÂ¢ÃÂÃÂ¦','ÃÂ¢ÃÂÃÂ ','ÃÂ¢ÃÂÃÂ¡','ÃÂÃÂ','ÃÂ¢ÃÂÃÂ°','ÃÂÃÂ ','ÃÂ¢ÃÂÃÂ¹','ÃÂÃÂ','ÃÂÃÂ½','ÃÂ¢ÃÂÃÂ','ÃÂ¢ÃÂÃÂ','ÃÂ¢ÃÂÃÂ','ÃÂ¢ÃÂÃÂ','ÃÂ¢ÃÂÃÂ¢','ÃÂ¢ÃÂÃÂ','ÃÂ¢ÃÂÃÂ','ÃÂÃÂ','ÃÂ¢ÃÂÃÂ¢','ÃÂÃÂ¡','ÃÂ¢ÃÂÃÂº','ÃÂÃÂ','ÃÂÃÂ¾','ÃÂÃÂ¸');
    ...
    static function strtocasefold($s, $full = true, $turkish = false)
    {
        ...
        if ($turkish)
        {
            false !== strpos($s, 'I') && $s = str_replace('I', 'ÃÂÃÂ±', $s);
            $full && false !== strpos($s, 'ÃÂÃÂ°') && $s = str_replace('ÃÂÃÂ°', 'i', $s);
        }
    ...
    {
/**/    if (extension_loaded('intl') && 'ÃÂÃÂ ' === grapheme_substr('ÃÂÃÂ©ÃÂÃÂ ', 1, -2))
/**/    {
...
/**/    }
    ...
    static function str_word_count($s, $format = 0, $charlist = '')
    {
        ...
        $s = preg_split("/({$charlist}+(?:[\p{Pd}ÃÂ¢ÃÂÃÂ']{$charlist}+)*)/u", $s, -1, PREG_SPLIT_DELIM_CAPTURE);
